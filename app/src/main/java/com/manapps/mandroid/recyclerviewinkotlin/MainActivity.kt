...
import com.manapps.mandroid.recyclerviewinkotlin.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), RecyclerViewItemClickListenerInterface {
    ...
    private fun showRecyclerViewData(dataModelList: MutableList<DataModel>) {
        recyclerViewItemAdapter = RecyclerViewItemAdapter(this, dataModelList, this)
